...
public class UsuarioController {
  ...
  @PostMapping
  public ResponseEntity<?> save(@Valid @RequestBody UsuarioRequestDto request) throws FirebaseAuthException {
  ...
  public ResponseEntity<?> validarCodigo(@PathVariable(name = "login") String login, @Valid @RequestBody CodigoRequestDto request) throws FirebaseAuthException {
