...
public class PresidenteValidationMessages {
  ...
  public static final String DOCUMENTO_TAMANHO = "O documento deve ter entre 11 e 14 caracteres";
  public static final String DATA_INICIO_MANDATO_OBRIGATORIA = "A data de início do mandato é obrigatória!";
  public static final String DATA_INICIO_MANDATO_TAMANHO = "A data de início do mandato deve ter 8 caracteres";
  ...
  public static final String DATA_FINAL_MANDATO_TAMANHO = "A data de final do mandato deve ter 8 caracteres";
  ...
  public static final String NOME_PAI_OBRIGATORIO = "O nome do pai é obrigatório!";
